...
/**
 * 凭证异常
 * {@link CredentialsException}
 * @author wangzb
 * @date 2020/4/3 10:51
 */
public class CredentialsExceptionHandler implements WebErrorHandler {
    /**
    ...
    public boolean canHandle(@Nullable Throwable exception) {
        return exception instanceof CredentialsException;
    }
    ...
    public HandledException handle(@Nullable Throwable exception) {
        return new HandledException(A0220, HttpStatus.BAD_REQUEST,"login.credentials_error");
    }
}
